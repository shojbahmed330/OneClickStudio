               ...
               {selectedFile ? (
                 <div className="flex-1 flex w-full h-full relative overflow-hidden">
                    ...
                    <textarea 
                       ...
                       className="flex-1 w-full bg-transparent py-4 md:py-8 px-4 font-mono text-[11px] md:text-[13px] text-zinc-300 outline-none resize-none custom-scrollbar leading-5 scroll-smooth whitespace-pre tab-size-2 overflow-x-auto overflow-y-auto" 
                       spellCheck={false}
                       autoCapitalize="none"
                       autoComplete="off"
                    />
